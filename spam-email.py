...
# Predict and evaluate training and test data
prediction_on_training_data = model.predict(X_train_features)
accuracy_on_training_data = accuracy_score(Y_train, prediction_on_training_data)
...
# Cross-validation scores: [0.93609865 0.93834081 0.94163861 0.94163861 0.94276094]
# Mean cross-validation score: 0.9400955242509802
...
# Model's full performance report
